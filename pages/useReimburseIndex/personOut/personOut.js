Page({
  ...
  onLoad() {
    ...
    dd.httpRequest({
      ...
      url: 'http://39.96.30.233:8080/zjp/constructionSite/findAll',
      method: 'POST',
      dataType: 'json',
      success: function(res) {
        dd.setStorage({
  ...
  saoMa(){
    ...
    dd.scan({
      ...
      dd.httpRequest({
        ...
        url: 'http://39.96.30.233:8080/zjp/userProduct/findByBarcode',
        method: 'POST',
        data:JSON.stringify({
  ...
  up:function(e){
    ...
    dd.httpRequest({
        ...
        url: 'http://39.96.30.233:8080/zjp/userProduct/editData',
        method: 'POST',
      ...
      dd.httpRequest({
        ...
        url: 'http://39.96.30.233:8080/zjp/userProductLog/addData',
        method: 'POST',
        data:JSON.stringify(that.data.arrayList),
        dataType: 'json', 
        success: function(res) {
